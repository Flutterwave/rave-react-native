...
- You should get this from your terminal:
  ...
  <img src="https://github.com/MaestroJolly/rave-react-native/blob/master/img/expo-barcode.PNG" style="text-align: center; max-height: 150px;" alt="Expo Terminal Image">
